#!/usr/bin/env python3
"""Orquestrator ISA — ChatCommerce Bot v2.3 (MINIMAL)"""
...
async def create_item(i: MenuItemCreate):
    try:
        ...
        if not cid:
            ...
            if cr.data: cid = cr.data[0]["id"]
        if not cid: raise HTTPException(400, detail="No client_id found")
